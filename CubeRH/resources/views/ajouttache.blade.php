            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="home"></i><span>Taches</span></a>
                    <ul class="nav-submenu menu-content">
                      <li><a href="#">Vos taches</a></li>
                      <li><a href="{{ route('ajouttache') }}">Nouveaux taches</a></li>
                      <li><a href="#">Taches employes</a></li>
                    </ul>
                  </li>
                  <li ><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="airplay"></i><span>Besoins</span></a>
                  </li>
                  <li ><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Statistiques</span></a>
                  </li>
                  <li ><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Cube RH</span></a>
                  </li>
                  <li ><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Organigramme</span></a>
                  </li>
        ...
        <div class="page-body">
          ...
          <div class="card">
            <div class="card-header pb-0">
              <h5>Taches</h5><span>Entrez votre nom et votre fonction pour  saisir vos taches .</span>
            </div>
            <div class="card-body">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header pb-0">
                <h5>Nouveaux Taches</h5><span>Saisissez le tache a effectuer</span>
              </div>
              <div class="card-body">
                <form class="form-space theme-form row">
                  <div class="mb-3">
                    <label class="col-form-label">Tache :</label>
                  ...
                  <div class="col-auto">
                    <label class="col-form-label pt-0" >Debut :</label> <input class="form-control" type="date" placeholder="Debut">
                  </div>
                  <div class="col-auto">
                    <label class="col-form-label pt-0" >Fin :</label> <input class="form-control" type="date" placeholder="Fin">
                  </div>
                </form>
              </div>
              <div class="card-footer">
